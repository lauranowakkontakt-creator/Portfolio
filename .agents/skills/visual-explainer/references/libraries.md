...
**Journalism, newsroom, and academic pairings** (use when the content is editorial, investigative, or scholarly):

| Body / Headings | Mono / Labels | Feel | Use for |
|---|---|---|---|
| Playfair Display | Source Serif Pro | Classic newspaper | Editorial broadsheet pages, longform features |
| DM Serif Display | DM Sans | Contemporary magazine | Magazine features, feature stories |
| Libre Baskerville | Fira Code | Scholarly, serious | Academic papers, research recaps |
| Bitter | Inconsolata | Working document | Newsroom dashboards, pitch packets |
| Instrument Serif | JetBrains Mono | Wire service / data | Source verification audits, investigation maps |
| Source Serif 4 | Source Sans 3 | Editorial restraint | Story structure, narrative arc reviews |

The first 5 of the upstream pairings are recommended for most use cases. Use the journalism pairings when the page is for a newsroom, editorial, investigative, or academic audience. Vary across consecutive diagrams.
