...
.outline-word {
  color: transparent;
  -webkit-text-stroke: 1.5px rgba(237,234,229,0.35);
}
...
.btn-ghost {
  ...
  text-transform: uppercase;
  border-bottom: 1px solid rgba(237,234,229,0.2);
  padding-bottom: 2px;
...
.btn-ghost:hover {
  color: var(--text);
  border-color: rgba(237,234,229,0.5);
}
...
.stat-item:first-child .stat { padding-left: 0; }
